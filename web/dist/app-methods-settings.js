window.scraperAppMethodsSettings = {
  async loadSettings() {
    try {
      ...
      if (this.cfg.metadata_refresh_ignore_episode_title_rules === undefined) this.cfg.metadata_refresh_ignore_episode_title_rules = '';
      if (this.cfg.metadata_refresh_skip_rules === undefined) this.cfg.metadata_refresh_skip_rules = '';
